...
namespace TIC_TAC_TOE
{
    class Program
    {
        //making array to track the user input
        ...
        {
            // loop will run until match will draw or any player wins
            do
            {
                Console.Clear();// screen will be clear
                ...
                Console.WriteLine("Enter the number from 0 to 8");
                try
                {
                ...
                if (choice > 8)
                {
                    Console.WriteLine("Please Enter the number from 0 to 8");
                    continue;
                }
